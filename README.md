...
1. [LINUX_QUICKSTART.md](docs/LINUX_QUICKSTART.md)
2. [VERSION_DIFF_NOTES.md](docs/VERSION_DIFF_NOTES.md)
...
- [_archive/legacy_web_scaffold](_archive/legacy_web_scaffold)
- [_references/source_packages](_references/source_packages)
...
- 原框架目录结构已经落地
- 顶层目录已简化，用户清单归入 `TestController/UserFiles`，目标机附加文件和设置归入 `Toolkit/UserFiles`、`Toolkit/Settings`
...
SIT-AUTO/
  ...
  Toolkit/                   目标机执行端
    UserFiles/               目标机侧附加文件
    Settings/                运行时设置
  TestController/UserFiles/  你要改的清单和计划
  scripts/                   Linux 启动脚本
  tests/                     当前主线测试
  docs/                      说明文档
  Results/                   运行结果
...
- `TestController/UserFiles/ServerLists/<你的清单>.yaml`
- `Toolkit/Settings/user-settings.json`
- `TestController/UserFiles/Plans/<你的计划>.yaml`
...
python TestController/StartController.py run-suite --name linux_smoke --server-list <你的清单> --jobs 2
...
- [StartController.py](TestController/StartController.py)

控制器执行链：

- [run_linux_suite.py](TestController/Commands/run_linux_suite.py)
- [run_master_suite.py](TestController/Commands/run_master_suite.py)
- [run_plan.py](TestController/Commands/run_plan.py)

检查与解析：

- [validate_platform.py](TestController/Commands/validate_platform.py)
- [parse_results.py](TestController/Commands/parse_results.py)

公共库：

- [controller_lib.py](TestController/Libraries/controller_lib.py)
- [plan_lib.py](TestController/Libraries/plan_lib.py)

Toolkit：

- [invoke_remote.py](Toolkit/invoke_remote.py)
- [toolkit_lib.py](Toolkit/Libraries/toolkit_lib.py)
...
- [LINUX_QUICKSTART.md](docs/LINUX_QUICKSTART.md)
- [SIT-AUTO使用手册.md](docs/SIT-AUTO使用手册.md)
- [PLATFORM_BLUEPRINT.md](docs/PLATFORM_BLUEPRINT.md)
- [VERSION_DIFF_NOTES.md](docs/VERSION_DIFF_NOTES.md)
